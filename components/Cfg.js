...
const _cfgPath = `${_path}/plugins/arknights-plugin/components/`
let cfg = {}

let configPath = `${_path}/plugins/arknights-plugin/config/`
let defSetPath = './plugins/arknights-plugin/defSet/'
