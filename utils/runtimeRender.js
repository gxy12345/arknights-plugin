  ...
  return e.runtime.render('arknights-plugin', path, renderData, {
    ...
    beforeRender ({ data }) {
      ...
      return {
        ...
        sys: {
          scale: pct,
          copyright: `Created By ${Version.name}<span class="version">${Version.yunzai}</span> & Arknights-plugin<span class="version">${Version.version}</span>`,
          createdby: `Created By ${Version.name} & Arknights-plugin`,
        },
        Math,
        MathPro,
        quality: 100
